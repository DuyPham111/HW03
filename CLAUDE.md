...
**Task 1A** — checklist > 40 item, phủ IA-01…IA-04. Mỗi item phải kiểm chứng được (nhìn màn hình kết luận Passed/Failed ngay) và có mã heuristic nguồn. Item do người bổ sung phải có lý do "vì sao AI sót" ở `team/ai-prompts.md`.
