...
4. Thêm **Mission/Task block**, dán nguyên văn: *"Khoa sắp có một workshop mà bạn muốn tham dự. Hãy đăng ký tham gia, rồi cho mình xem lại đăng ký đó."* — giữ đúng dạng mục tiêu, không thêm bước bấm cụ thể. ⚠️ **Đã chốt 06/08/2026: không dùng bản QR.** QR trên EMS là mã cố định theo tài khoản (không đổi theo có đăng ký hay không), nên làm tiêu chí hoàn thành yếu hơn hẳn "tìm lại được đăng ký trong My Activities" — xem `02-usability-report.md` §1.1.
...
7. Thêm 5 block **Open question**, dán 5 câu hỏi mở đã chốt ở `02-usability-report.md` §1.3 (clarity/error recovery/speed/trust + 1 câu tổng quát). ✅ *Khôi phục 06/08/2026* — dữ liệu này bổ sung cho cuộc gọi song song chứ không trùng: cuộc gọi bắt giọng điệu lúc đang làm, Open Question bắt câu trả lời đã suy nghĩ lại sau khi xong việc.
