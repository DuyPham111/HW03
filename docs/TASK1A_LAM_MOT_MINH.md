...
**Ký hiệu cột Nguồn gốc:** `AI` = AI sinh ở lượt đầu · `RV` = bạn bổ sung khi review (phải có lý do ở `team/references.md` · `team/ai-prompts.md`)
...
Với **mỗi item bạn tự thêm**, ghi ngay một dòng vào `team/references.md` · `team/ai-prompts.md` mục 3, chọn 1 trong 3 loại lý do:
...
- [ ] Số item `RV` khớp với số dòng giải thích ở `team/references.md` · `team/ai-prompts.md`
- [ ] Điền `team/references.md` · `team/ai-prompts.md`: nguồn nào dùng cho item nào
