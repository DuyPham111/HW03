...
**WEB:** <u>https://promoter-starboard-prude.ngrok-free.dev/</u> 
...
**Sau khi hoàn thành** , vui lòng điền vào bảng E2E Test Flow và gửi về link Biểu mẫu phản hồi: <u>https://forms.gle/CJQFQCAXcsDbXDMM9</u> 
...
- **Hành động:** 
   ...
   - **Academic Contexts:** Tạo cấu trúc 3 cấp (Program -> Year -> Semester). Dùng chuột kéo thả (Reorder) để đổi thứ tự. Thử tạo nhanh danh mục con từ chính dòng 
...
- **Kết quả mong đợi:** Hệ thống bắt đúng các logic trạng thái. Nhật ký quét cập nhật realtime. Nút xuất Excel lịch sử quét hoạt động. 
...
- **Hành động:** 
   ...
   - **Analytics:** Kiểm tra Overview, Events Stats (test sub-tab CAMPUS), Checkins Stats (kiểm tra breakdown nguồn check-in và Waitlist conversion rate). Test bộ lọc 
