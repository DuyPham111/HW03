...
| **S-16** | Chỉ số dashboard phải khớp dữ liệu thật | (c) | Quan sát trực tiếp: **cả 4 thẻ KPI đều bằng 0** — `Total Events 0`, `Total Check-ins 0`, `Attendance Rate 0%`, `Total Users 0` — trong khi ngay trên cùng màn hình đó, badge `Support requests` đang hiện **17**, tức hệ thống chắc chắn có dữ liệu. AI không có cách nào biết chỉ số của một hệ thống cụ thể đang sai; đây thuần tuý là kết quả của việc mở trang lên và nhìn |
