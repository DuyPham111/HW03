...
| N-03 | Back trình duyệt giữ nguyên bộ lọc/trang/vị trí cuộn | IA-03 | Failed | | | S1 = cùng bằng chứng với `N-06` — bấm Back sau khi lọc, bộ lọc mất sạch | S1: `CL-B1-02` | [N-06-S1-before.png](evidence/task1b/N-06-S1-before.png) · [N-06-S1-after.png](evidence/task1b/N-06-S1-after.png) |
...
| S-09 | Ngày giờ 1 định dạng thống nhất, nêu múi giờ ở hạn chót | IA-04 | ⚠️ | ⚠️ | ⚠️ | **Nửa đầu (định dạng thống nhất) — đã xác nhận đạt**, ví dụ bạn đưa `03/08/2026 08:00` khớp với `dd/MM/yyyy HH:mm` thấy ở mọi nơi khác. **Nửa sau (nêu múi giờ) — chưa thấy bằng chứng nào nói có**: ví dụ bạn đưa ra cũng không có `GMT+7`/`(UTC+7)` đi kèm, khớp với quan sát cũ (O13) là không thấy múi giờ ở đâu cả. ⚠️ **Câu hỏi cho bạn:** bạn có tìm thấy múi giờ ghi ở BẤT KỲ đâu trong hệ thống không (kể cả góc khuất, tooltip, hay trang Settings)? Nếu thật sự không có thì item này phải là **Failed** (thiếu nửa sau), không phải Passed — chỉ đạt "định dạng thống nhất" thôi thì chưa đủ | | |
