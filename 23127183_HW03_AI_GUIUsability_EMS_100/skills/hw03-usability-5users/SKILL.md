...
- **Task scenario nêu MỤC TIÊU, không nêu các bước bấm.** Viết "đăng ký một workshop sắp diễn ra và cho tôi xem mã QR check-in của bạn" — không viết "bấm vào Events, chọn sự kiện, bấm Register".
